...
//             onPress={() => setActiveTab("posts")}
//           >
//             <Text style={[styles.tabText, { color: activeTab === "posts" ? colors.primary : colors.text }]}>
//               Posts
//             </Text>
//           </TouchableOpacity>
//           <TouchableOpacity
...
//           >
//             <Text
//               style={[styles.tabText, { color: activeTab === "followers" ? colors.primary : colors.text }]}
//             >
//               Followers
//             </Text>
//           </TouchableOpacity>
...
//           >
//             <Text
//               style={[styles.tabText, { color: activeTab === "following" ? colors.primary : colors.text }]}
//             >
//               Following
//             </Text>
//           </TouchableOpacity>
